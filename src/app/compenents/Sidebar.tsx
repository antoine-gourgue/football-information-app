...
import LinkSide from "@/app/compenents/LinkSide";

const  Sidebar :FC = () => {
    const Leagues = [
        {id:1, name:"Premier League", href:"premier-league", emblem:"/img/leagues/premier_league.webp"},
        {id:2, name:"Primera Divison", href:"la-liga", emblem:"/img/leagues/laliga.svg"},
        {id:3, name:"Bundesliga", href:"bundesliga", emblem:"/img/leagues/bundesliga.webp"},
        {id:4, name:"Seria A", href:"serie-a", emblem:"/img/leagues/serie_a.webp"},
